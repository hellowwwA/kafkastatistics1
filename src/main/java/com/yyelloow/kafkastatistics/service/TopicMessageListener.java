...
public class TopicMessageListener {
    ...
    @KafkaListener(topics = "topic_registration", groupId = "group4")
    public void onRegistrationMessage(@Payload String message, @Header("type") String type) throws Exception {
        ...
        if(!statistic.containsKey("topic_registration")){
            statistic.put("topic_registration",0);
        }
        int num=statistic.get("topic_registration");
        statistic.put("topic_registration",num+1);
    ...
    public void onLoginMessage(@Payload String message, @Header("type") String type) throws Exception {
        ...
        if(!statistic.containsKey("topic_login")){
            statistic.put("topic_login",0);
        }
        int num=statistic.get("topic_login");
        statistic.put("topic_login",num+1);
        System.out.println(num+1);
    }
